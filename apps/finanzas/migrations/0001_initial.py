    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, null=True, upload_to='icon_categoriagastos')),
                ('color', colorfield.fields.ColorField(default='#FF0000', image_field=None, max_length=18, samples=None)),
                ('tipo_de_gasto', models.CharField(choices=[('F', 'Fijo-Obligatorio'), ('N', 'Necesario-Sobrevivencia'), ('P', 'Prescindible-Lujo')], default='F', max_length=1)),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='finanzas.categorias')),
            ],
            options={
